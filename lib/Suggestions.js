...
function filterSuggestions (query, suggestions, length, ignoreFilter) {
  if (ignoreFilter) {
    return suggestions
  }
...
class Suggestions extends React.Component {
  constructor (props) {
    ...
    this.state = {
      options: filterSuggestions(this.props.query, this.props.suggestions, this.props.maxSuggestionsLength, this.props.ignoreFilterSuggestions)
    }
  }

  componentWillReceiveProps (newProps) {
    this.setState({
      options: filterSuggestions(newProps.query, newProps.suggestions, newProps.maxSuggestionsLength, newProps.ignoreFilterSuggestions)
    })
  }
