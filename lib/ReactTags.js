...
function getOptions(props, state) {
  ...
  if (props.allowNew && props.newTagText && findMatchIndex(options, state.query) === 0) {
    options.push({ id: -1, name: state.query, prefix: props.newTagText, disableMarkIt: true, className: props && props.classNameCreateTagSuggestions || '' });
  } else if (props.noSuggestionsText && options.length === 0) {
    options.push({ id: -1, name: state.query, disabled: false, disableMarkIt: true, className: props && props.classNameCreateTagEmptySuggestions || '' });
  }
...
ReactTags.defaultProps = {
  id: 'ReactTags',
  tags: [],
  classNameCreateTagSuggestions: '',
  classNameCreateTagEmptySuggestions: '',
...
ReactTags.propTypes = {
  ...
  classNameCreateTagSuggestions: PropTypes.string,
  classNameCreateTagEmptySuggestions: PropTypes.string,
