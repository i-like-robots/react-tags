...
class ReactTags extends React.Component {
  ...
  handleKeyDown (e) {
    ...
    let shouldAdd = e.keyCode === KEYS.ENTER || e.keyCode === KEYS.TAB

    // if delimiters were explicitly provided, reasses based on delimiters.
    if (this.props.delimiters) {
      shouldAdd = this.props.delimiters.indexOf(e.key) !== -1
    }
