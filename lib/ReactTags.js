...
class ReactTags extends React.Component {
  ...
  onKeyDown (e) {
    ...
    // when backspace key is pressed and query is blank, delete the last tag
    if (e.keyCode === KEYS.BACKSPACE && this.props.allowBackspace) {
      pressBackspaceKey.call(this, e)
    }

    if (e.keyCode === KEYS.UP_ARROW || e.keyCode === KEYS.UP_ARROW_COMPAT) {
      pressUpKey.call(this, e)
    }

    if (e.keyCode === KEYS.DOWN_ARROW || e.keyCode === KEYS.DOWN_ARROW_COMPAT) {
