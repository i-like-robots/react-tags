...
module.exports = React.createClass({
    ...
    updateInputWidth() {
        this.isMounted() && this.props.autoresize && this.setState({
            inputWidth: Math.max(this.refs.sizer.scrollWidth) + 10
        });
    },
    ...
    render() {
        ...
        // Sizer
        const sizer = (
            <div ref='sizer' className='ReactTags__sizer' style={SizerStyle}>
                {query || placeholder || ''}
            </div>
        );
        ...
        const tagInput = (
            <div className='ReactTags__tagInput'>
                <input
                    ...
                    style={{ width: this.state.inputWidth, maxWidth: '100%' }} />
                {this.props.autoresize ? sizer : null}
