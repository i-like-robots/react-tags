	    ...
	    return (
	      react.createElement( 'div', { className: classNames.searchWrapper },
	        react.createElement( 'input', Object.assign({},
	          inputAttributes, inputEventHandlers, { ref: this.input, value: query, placeholder: placeholder, className: classNames.searchInput, role: 'combobox', 'aria-autocomplete': 'list', 'aria-label': placeholder, 'aria-owns': id, 'aria-activedescendant': index > -1 ? (id + "-" + index) : null, 'aria-expanded': expanded, style: { width: this.state.inputWidth } })),
	        react.createElement( 'div', { ref: this.sizer, style: SIZER_STYLES }, query || placeholder)
	      )
	    )
	  };
	        ...
	        react.createElement( 'div', {
	          ...
	          this.props.tags.map(function (tag, i) { return (
	            react.createElement( TagComponent, {
	              key: i, tag: tag, classNames: this$1.props.classNames, onDelete: this$1.deleteTag.bind(this$1, i) })
	          ); })
	        ),
	        react.createElement( 'div', { className: this.props.classNames.search },
	          react.createElement( Input, Object.assign({},
	            this.state, { id: this.props.id, ref: this.input, classNames: this.props.classNames, inputAttributes: this.props.inputAttributes, inputEventHandlers: this.inputEventHandlers, autoresize: this.props.autoresize, expanded: expanded, placeholder: this.props.placeholder })),
